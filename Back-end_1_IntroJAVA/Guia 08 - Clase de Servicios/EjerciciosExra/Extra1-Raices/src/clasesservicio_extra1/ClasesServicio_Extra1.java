package clasesservicio_extra1;

import clasesservicio_extra1.entidades.Raices;
import clasesservicio_extra1.servicios.RaicesServicio;

public class ClasesServicio_Extra1 {
//    Vamos a realizar una clase llamada Raices, donde representaremos los valores de una ecuación de 2º grado. Tendremos
//    los 3 coeficientes como atributos, llamémosles a, b y c. Hay que insertar estos 3 valores para construir el objeto
//    a través de un método constructor. Luego, en RaicesServicio las operaciones que se podrán realizar son las siguientes:
...
//    Nota: Fórmula ecuación 2o grado: (-b±√((b^2)-(4*a*c)))/(2*a) Solo varía el signo delante de -b
    ...
    public static void main(String[] args) {
        RaicesServicio rServicio = new RaicesServicio();
        Raices raices = new Raices(-5, 7, 2);
        
        rServicio.mostrarEcuación(raices);
        rServicio.calcular(raices);
    }
