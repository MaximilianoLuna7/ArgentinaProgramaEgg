package clasesutilidad_ejercicio6;

import clasesutilidad_ejercicio6.entidades.Curso;
import clasesutilidad_ejercicio6.servicios.CursoServicio;

/**
 * @author Maximiliano Luna
 */
public class ClasesUtilidad_Ejercicio6 {
...
//    Donde alumnos es un arreglo de tipo String de dimensión 5 (cinco), donde se alojarán los nombres de cada
//    alumno. A continuación, se implementarán los siguientes métodos:
...
//    la cantidad de días a la semana que se repite el encuentro.
    ...
    public static void main(String[] args) {
        ...
        Curso curso1 = cursoServicio.creaCurso();
        cursoServicio.dejarDeLeer();
        System.out.println("------------------");
        System.out.println("La ganancia semanal del curso " + curso1.getNombreCurso() + " será de $" + cursoServicio.calcularGananciaSemanal(curso1));
    }
