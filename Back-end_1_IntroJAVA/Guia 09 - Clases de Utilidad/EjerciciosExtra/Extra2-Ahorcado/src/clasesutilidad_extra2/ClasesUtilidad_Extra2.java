package clasesutilidad_extra2;

import clasesutilidad_extra2.entidades.Ahorcado;
import clasesutilidad_extra2.servicios.AhorcadoServicio;

/**
 * @author Maximiliano Luna
 */
public class ClasesUtilidad_Extra2 {
//    Juego Ahorcado: Crear una clase Ahorcado (como el juego), la cual deberá contener como atributos, un vector con
//    la palabra a buscar, la cantidad de letras encontradas y la cantidad jugadas máximas que puede realizar el
...
//    Mensaje: Lo sentimos, no hay más oportunidades
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            System.out.println(""); //Se imprimen espacios para que el otro jugador no vea lo que se ingresó.
        }
        
        ahorcadoServicio.juego(ahorcado);
        
        ahorcadoServicio.dejarDeLeer();
    }
